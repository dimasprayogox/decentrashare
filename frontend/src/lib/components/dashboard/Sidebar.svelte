<script lang="ts">
  ...
  const STYLES = {
    ...
    active: `
      ...
      bg-gradient-to-r from-blue-50/50 via-blue-50/30 to-transparent dark:from-blue-600/20 dark:via-blue-600/10 dark:to-transparent
      text-blue-600 dark:text-blue-300 font-semibold
      shadow-[inset_0_0_30px_rgba(37,99,235,0.04)] dark:shadow-[inset_0_0_30px_rgba(37,99,235,0.15),0_0_20px_rgba(59,130,246,0.1)]
      border-r-2 border-blue-500 dark:border-blue-400
      before:absolute before:inset-0 before:bg-gradient-to-r before:from-blue-500/5 dark:before:from-blue-500/10 before:via-transparent before:to-transparent
      before:animate-shimmer
    `,
    // Main nav item - Inactive: Subtle hover
    inactive: `
      text-slate-600 dark:text-gray-400 hover:text-slate-900 dark:hover:text-gray-200
      hover:bg-slate-100/40 dark:hover:bg-white/[0.05] hover:shadow-[inset_0_0_15px_rgba(15,23,42,0.02)] dark:hover:shadow-[inset_0_0_15px_rgba(255,255,255,0.03)]
      border-r-2 border-transparent
      transition-all duration-200
    `,
    // Sub nav item - Active
    subActive: `
      bg-gradient-to-r from-blue-50/30 to-transparent dark:from-blue-600/15 dark:to-transparent
      text-blue-600 dark:text-blue-300 font-medium
      border-l-2 border-blue-500 dark:border-blue-400 pl-5
      shadow-[inset_0_0_10px_rgba(37,99,235,0.02)] dark:shadow-[inset_0_0_10px_rgba(37,99,235,0.1)]
    `,
    // Sub nav item - Inactive
    subInactive: `
      text-slate-500 dark:text-gray-550 hover:text-slate-700 dark:hover:text-gray-300
      hover:bg-slate-50 dark:hover:bg-white/[0.03]
      border-l-2 border-transparent pl-5
      transition-all duration-200
    `,
    // Icon colors
    iconInactive: 'text-slate-400 dark:text-gray-550 group-hover:text-slate-600 dark:group-hover:text-gray-300',
    iconActive: 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]'
  } as const;
  ...
  // ── Icons ──
  const Icons = {
    WalletActivity: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-650 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>`,
    Storage: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-650 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4"></path></svg>`,
    Explore: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-650 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35m1.1-5.4a6.5 6.5 0 11-13 0 6.5 6.5 0 0113 0z"></path></svg>`,
    Shared: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-650 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"></path></svg>`,
    Validate: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-650 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>`,
    Trash: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-650 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M9 7V4a1 1 0 011-1h4a1 1 0 011 1v3m-8 0h10"></path></svg>`,
    Settings: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-650 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>`,
    Admin: (isActive: boolean) => `<svg class="w-5 h-5 transition-all duration-300 ${isActive ? 'text-blue-650 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-550 group-hover:text-slate-600 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>`,
    Profile: (isActive: boolean) => `<svg class="w-4 h-4 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-300' : 'opacity-70 group-hover:opacity-100 text-slate-500 dark:text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>`,
    Security: (isActive: boolean) => `<svg class="w-4 h-4 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-300' : 'opacity-70 group-hover:opacity-100 text-slate-500 dark:text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>`,
    Notifications: (isActive: boolean) => `<svg class="w-4 h-4 transition-all duration-300 ${isActive ? 'text-blue-600 dark:text-blue-300' : 'opacity-70 group-hover:opacity-100 text-slate-500 dark:text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>`,
    ...
    ChevronDown: (expanded: boolean) => `<svg class="w-4 h-4 text-slate-400 dark:text-gray-500 transition-transform duration-200 ${expanded ? 'rotate-180' : ''}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>`,
    ...
    ActiveDot: () => `<span class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-gradient-to-b from-blue-500 to-cyan-500 dark:from-blue-400 dark:to-cyan-400 rounded-r-full shadow-[0_0_10px_rgba(59,130,246,0.6)] dark:shadow-[0_0_10px_rgba(59,130,246,0.8)] animate-pulse"></span>`
  };
</script>
...
<!-- Sidebar Container -->
<aside class="
  fixed lg:sticky top-0 left-0 z-[100] h-screen bg-[#0a0a0c] lg:bg-[#0a0a0c] 
  border-r border-slate-200/65 dark:border-white/5 backdrop-blur-2xl p-6 flex flex-col 
...
">
  ...
  <div class="flex items-center gap-3 mb-12 px-2">
    ...
    <span class="text-2xl font-bold tracking-tighter text-slate-800 dark:text-white">
      Decentra<span class="text-blue-600 dark:text-blue-400 drop-shadow-[0_0_10px_rgba(59,130,246,0.2)] dark:drop-shadow-[0_0_10px_rgba(59,130,246,0.4)]">Share</span>
    </span>
  </div>
  ...
  <nav class="flex-1 space-y-1.5 overflow-y-auto pr-2 custom-scrollbar">
    ...
    <a href="/contract-activity"
        ...
        <svg class="w-5 h-5 transition-all duration-300 {active === 'contract-activity' ? 'text-blue-650 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-500 group-hover:text-slate-600 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/></svg>
    ...
    <a href="/activity"
      ...
      <svg class="w-5 h-5 transition-all duration-300 {active === 'activity' ? 'text-blue-650 dark:text-blue-400 drop-shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:drop-shadow-[0_0_8px_rgba(59,130,246,0.5)] scale-110' : 'text-slate-400 dark:text-gray-550 group-hover:text-slate-600 dark:group-hover:text-gray-300'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="pl-4 space-y-1 pt-1">
          ...
          <a href="/settings/profile" 
            ...
            {#if active === 'settings' && subActive === 'profile'}
              <span class="absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-4 bg-blue-500 dark:bg-blue-400 rounded-r animate-pulse"></span>
            {/if}
    ...
    <button 
      ...
      class="group relative w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-medium 
             text-red-500/80 dark:text-red-400/80 hover:text-red-650 dark:hover:text-red-300
             hover:bg-red-500/5 dark:hover:bg-red-500/10 hover:shadow-[inset_0_0_20px_rgba(239,68,68,0.03)] dark:hover:shadow-[inset_0_0_20px_rgba(239,68,68,0.1)]
             transition-all duration-300 border-r-2 border-transparent 
             hover:border-red-500/40 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
  ...
  <div class="mt-auto space-y-4 pt-6 border-t border-slate-200/60 dark:border-white/5">
    <div class="relative overflow-hidden p-5 rounded-3xl bg-slate-100/40 dark:bg-white/[0.03] 
                border border-slate-200/60 dark:border-white/5 shadow-sm dark:shadow-2xl
                hover:shadow-[0_0_30px_rgba(59,130,246,0.05)] dark:hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] transition-shadow duration-300">
      <div class="absolute top-0 right-0 w-24 h-24 bg-blue-600/5 dark:bg-blue-600/10 blur-[40px] -z-10 animate-pulse"></div>

      {#if isUnlimited}
        <!-- Unlimited (mis. ADMIN) -->
        <div class="flex items-center justify-between mb-2">
          <p class="text-[10px] text-slate-500 dark:text-gray-550 uppercase tracking-widest">Storage</p>
          <span class="inline-flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider text-blue-600 dark:text-blue-300 bg-blue-500/10 dark:bg-blue-500/15 border border-blue-500/20 dark:border-blue-500/30 px-1.5 py-0.5 rounded">
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
            Unlimited
          </span>
        </div>
        <p class="text-sm font-bold text-blue-600 dark:text-blue-300">
          {storageUsedLabel} <span class="text-sm font-normal text-slate-500 dark:text-gray-400">used</span>
        </p>
      {:else}
        <!-- Used / Quota + percentage -->
        <div class="flex justify-between items-end mb-3">
          <div>
            <p class="text-[10px] text-slate-500 dark:text-gray-550 uppercase tracking-widest mb-1">Storage</p>
            <p class="text-sm font-bold {isStorageCritical ? 'text-red-500 dark:text-red-400' : 'text-blue-600 dark:text-blue-300'}">
              {storageUsedLabel}
              <span class="text-sm font-normal text-slate-500 dark:text-gray-400">/ {storageQuotaLabel}</span>
            </p>
          </div>
          <span class="text-sm font-bold {isStorageCritical ? 'text-red-500' : 'text-slate-800 dark:text-white'}">{storagePercentLabel}</span>
        </div>

        <!-- Progress bar -->
        <div class="h-2 bg-slate-200/60 dark:bg-white/5 rounded-full overflow-hidden">
          <div
        ...
        {#if isStorageCritical}
          <p class="mt-2 text-[10px] text-red-500 dark:text-red-400">Storage almost full</p>
        {/if}
      {/if}
    </div>
  </div>
