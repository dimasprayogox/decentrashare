...
describe("DecentraShare - verifyOwner() Unit Testing", function () {
  ...
  it("Jalur Basis: Kembalikan alamat owner yang sah untuk CID terdaftar", async function () {
  ...
  it("Jalur Basis: Kembalikan ZeroAddress untuk CID yang tidak terdaftar", async function () {
