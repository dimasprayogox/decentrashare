...
describe('archiveDocuments()', () => {
  ...
  test('Path 1 (Valid): mengarsip satu dokumen (memicu log ARCHIVE)', async () => {
  ...
  test('Path 2 (Valid): mengarsip banyak dokumen secara massal (memicu log BULK_ARCHIVE)', async () => {
    const { archiveDocuments } = await import('../../src/modules/document/document.service?cache-bust=09');
  ...
  test('Path 3 (Tidak Valid/Batas): tidak ada dokumen valid untuk diarsip', async () => {
    const { archiveDocuments } = await import('../../src/modules/document/document.service?cache-bust=09');
...
describe('restoreDocuments()', () => {
  ...
  test('Path 1 (Valid): memulihkan dokumen ke folder asalnya jika folder tersebut aktif', async () => {
  ...
  test('Path 2 (Valid): memulihkan ke root dengan nama baru jika folder asal hilang dan ada tabrakan nama di root', async () => {
    const { restoreDocuments } = await import('../../src/modules/document/document.service?cache-bust=09');
  ...
  test('Path 3 (Tidak Valid/Batas): tidak ada dokumen untuk dipulihkan', async () => {
    const { restoreDocuments } = await import('../../src/modules/document/document.service?cache-bust=09');
...
describe('destroyMultipleDocuments()', () => {
  ...
  test('Path 1 (Valid): memusnahkan dokumen terarsip (memicu unpin Pinata dan penghapusan database)', async () => {
  ...
  test('Path 2 (Tidak Valid/Batas): tidak ada dokumen terarsip untuk dimusnahkan', async () => {
    const { destroyMultipleDocuments } = await import('../../src/modules/document/document.service?cache-bust=09');
